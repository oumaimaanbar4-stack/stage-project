  ...
  const columns = [
    ...
    { 
      ...
      renderCell: (params) => {
        ...
        return date.toLocaleDateString('fr-FR'); // Returns DD/MM/YYYY
      }
    },
    ...
    { 
      ...
      renderCell: (params) => (
        <Chip 
          label={params.value} 
          color={params.row.dernierStatut === 'liv' ? 'success' : 'warning'} 
          size="small" 
        />
      )
    },
  ...
  return (
    <>
      ...
      <Box sx={{ p: 2, backgroundColor: '#f4f6f8', minHeight: '100vh' }}>
        ...
        <Box sx={{ mb: 2, backgroundColor: '#fff', borderRadius: '4px' }}><PageTabs /></Box>
